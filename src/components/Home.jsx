...
const Home = () => {
  return (
    <section id='home' className="pt-40 h-screen mt-20">
      <div className="container mx-auto flex justify-center items-center gap-20">
        ...
        <div className="flex gap-4 flex-col">
          ...
          <div className="flex gap-4">
            ...
            <button className="border border-black rounded-3xl p-4 text-sm font-bold text-white bg-gray-700 hover:bg-gray-600">Contact Info</button>
          </div>
