      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 mt-4 w-full md:w-4/5">
        ...
        ">
          ...
          <div className="flex flex-row md:flex-row gap-4 items-center justify-center mt-8 w-full md:w-96" >
            ...
            <div className="border border-black rounded-3xl flex flex-col justify-center items-center gap-2 p-4 hover:text-blue-700 hover:underline transition-all duration-300 h-1/2 w-1/2" onClick={togglePopup2}>
              <FaPeopleGroup />
