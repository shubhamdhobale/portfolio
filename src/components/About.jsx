...
const About = () => {
  ...
  const certifications = [
    {
      id:1,
      certificateName:"1. MERN Stack Developer",
  ...
  return (
    <motion.section id="about" className="h-screen pt-40 flex flex-col items-center" initial={{opacity:0}} animate={{opacity: 1}} transition={{duration: 5}}>
                  ...
                  <hr className="border border-blue-700 w-full my-2"/>
                    {
                      internships.map((internship) => {
                        return(
                          <div key={internship.id} className="flex flex-row gap-4">
                            ...
                            <div>
                              ...
                              <a href={internship.certificate} className="underline" target="_blank">- certificate</a>
                            </div>
                          </div>
                        )
                      })
            ...
            <div className=" border border-black rounded-3xl flex flex-col justify-center items-center gap-2 p-4 hover:text-blue-700 hover:underline transition-all duration-300 h-24 w-60" onClick={togglePopup2}>
              ...
              <motion.div className="flex gap-2" initial={{opacity : 0}} animate={{opacity: 1}} transition={{duration : 2}}>
                <div className="flex flex-col gap-32 mt-4">
                  <FaDiamond />
                  <FaDiamond />
                  <FaDiamond className="bottom-14 relative"/>
                </div>
              ...
              <button onClick={togglePopup2} className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 mt-4 left-72 drop-shadow-2xl relative px-4 rounded">
                Close
              </button>
              </div>
              </div>
